...
So, we decided to do something about it! We created a web page using [readthedocs](https://readthedocs.org/) that walks through setting up a useful Python ecosystem and also contains brief overviews of popular scientific packages and visualization tools. 
